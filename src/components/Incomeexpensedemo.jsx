...
const Incomeexpensedemo = () => {
  return (
    <div name="incomeexpensedemo" className='w-full min-h-screen flex flex-col justify-center items-center p-4'>
        <div className='h-[80px]'></div>
        <p className='text-4xl font-bold inline border-b-4 border-[#5C8374] mb-6'>Income Expense Tracker Project</p>
...
export default Incomeexpensedemo